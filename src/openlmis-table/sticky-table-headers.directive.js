...
(function() {
     ...
     * Rows have to be inside element with thead class.
     * This directive is changed in Malawi implementation to affect only cells in thead tags,
     * because it was affecting tfoot directive that was added.
     *
     * @example
     * ```
