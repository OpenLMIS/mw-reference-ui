...
describe('ConvertToOrderController', function(){
    ...
    describe('search', function() {
        ...
        it('should call state go method with filterValue provided by user and filterBy all', function() {
        ...
        it('should call state go method with filterBy programName if filterValue is default', function() {
            vm.filterBy = 'filterBy';
			vm.filterValue = ['Essential Meds', 'TB'];
			vm.sortBy = 'sortBy';
			vm.descending = true;
        ...
        it('should call state go method with filterBy programName if filterValue is not provided', function() {
            vm.filterBy = 'filterBy';
			vm.filterValue = [];
			vm.sortBy = 'sortBy';
			vm.descending = true;
